...
module.exports = __webpack_require__(/*! /home/lorenzo/Development/seo-app/src/main.ts */"zUnb");
...
class HomeComponent {
    constructor(productService, titleService, meta) {
        ...
        this.meta.updateTag({ name: 'description', content: `${_environments_environment_prod__WEBPACK_IMPORTED_MODULE_0__["environment"].shopName} is shop voor axxes IT consultants` });
        this.meta.updateTag({ name: 'og:description', content: `${_environments_environment_prod__WEBPACK_IMPORTED_MODULE_0__["environment"].shopName} is shop voor axxes IT consultants` });
        this.meta.updateTag({ name: 'og:image', content: `https://axxes.com/wp-content/themes/axxes/img/layout/logo_new.png` });
        this.meta.updateTag({ name: 'og:type', content: 'website' });
        this.meta.updateTag({ name: 'og:url', content: _environments_environment_prod__WEBPACK_IMPORTED_MODULE_0__["environment"].url });
        /*
...
const environment = {
    ...
    url: 'https://seo-axxes-app.herokuapp.com'
};
/*
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"],
        ...
        _footer_footer_component__WEBPACK_IMPORTED_MODULE_12__["FooterComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"],
        _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_4__["BrowserAnimationsModule"],
        _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_8__["MatToolbarModule"],
        _angular_material_card__WEBPACK_IMPORTED_MODULE_9__["MatCardModule"],
        _angular_material_grid_list__WEBPACK_IMPORTED_MODULE_10__["MatGridListModule"],
...
class DetailComponent {
    constructor(route, productService, titleService, meta) {
        this.route = route;
        this.productService = productService;
        this.titleService = titleService;
        this.meta = meta;
        this.product$ = this.productService.getProduct(this.route.snapshot.params.id)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])((product) => {
            this.titleService.setTitle(`${_environments_environment_prod__WEBPACK_IMPORTED_MODULE_0__["environment"].shopName} - ${product.title}`);
            ...
            this.meta.addTag({ name: 'og:url', content: `${_environments_environment_prod__WEBPACK_IMPORTED_MODULE_0__["environment"].url}/monitor/${product.productId}` });
        }));
    }
    ngOnInit() {
    }
